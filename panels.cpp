  ...
  , timer(this, TIMER_ID2)
{
  ...
  auto szl = new wxBoxSizer(wxVERTICAL);
  {
    ...
    wxButton* btn = new wxButton(this, wxID_OK, "Capture");
    btn->SetDefault();
    szl->Add(btn, wxSizerFlags(0).Left());
  }

  auto szr = new wxBoxSizer(wxVERTICAL);
  {
    auto nb = new wxNotebook(this, wxID_ANY, wxDefaultPosition, wxSize(FromDIP(300), FromDIP(340)));
    auto sb = new wxGenericStaticBitmap(nb, wxID_ANY, wxImage("0.jpg"));
    sb->SetScaleMode(wxStaticBitmapBase::Scale_AspectFit);
    sb->SetBackgroundColour(wxColour(38, 38, 38));
    nb->AddPage(sb, "Face1");
    szr->Add(nb, wxSizerFlags(0).Center());
    ...
    fgs->Add(new wxStaticTextEx(this, wxID_ANY, "Name: ", wxDefaultPosition, wxSize(-1, h), wxALIGN_CENTER_VERTICAL), wxSizerFlags(0).Left());
  ...
  szm->Add(szr);
  sz->Add(szm, wxSizerFlags(1).Expand().Border(wxALL, FromDIP(10)));
  SetSizer(sz);
}
  ...
  : wxPanel(parent, id, pos, size, style)
{
  ...
  szl = new wxGridSizer(4);
  {
    for (int c = 0; c < 6; c++)
    {
      ...
      cell->Add(new wxButton(this, wxID_ANY, "Detail", wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT));
  ...
  szr = new wxBoxSizer(wxVERTICAL);
  {
    ...
    sb->SetBackgroundColour(wxColour(38, 38, 38));
    nb->AddPage(sb, "Face1");
    szr->Add(nb, wxSizerFlags(0).Expand());
    ...
    fgs->Add(new wxStaticTextEx(this, wxID_ANY, "Name: ", wxDefaultPosition, wxSize(-1, h), wxALIGN_CENTER_VERTICAL), wxSizerFlags(0).Left());
    fgs->Add(new wxTextCtrl(this, wxID_ANY), wxSizerFlags(1).Expand());

    fgs->Add(new wxStaticTextEx(this, wxID_ANY, "Regist date: ", wxDefaultPosition, wxSize(-1, h), wxALIGN_CENTER_VERTICAL), wxSizerFlags(0).Left());
    fgs->Add(new wxStaticTextEx(this, wxID_ANY, "2022.06.01", wxDefaultPosition, wxSize(-1, h), wxALIGN_CENTER_VERTICAL), wxSizerFlags(1).CenterVertical().Expand());

    fgs->Add(new wxStaticTextEx(this, wxID_ANY, "Last Approved date: ", wxDefaultPosition, wxSize(-1, h), wxALIGN_CENTER_VERTICAL), wxSizerFlags(0).Left());
    fgs->Add(new wxStaticTextEx(this, wxID_ANY, "-1", wxDefaultPosition, wxSize(-1, h), wxALIGN_CENTER_VERTICAL), wxSizerFlags(1).CenterVertical().Expand());
    szr->Add(fgs, wxSizerFlags(1).Expand().Border(wxTOP, FromDIP(20)));

    auto szh = new wxBoxSizer(wxHORIZONTAL);
    szh->Add(new wxButton(this, wxID_ANY, "Edit"), wxSizerFlags(0).Border(wxRIGHT, FromDIP(5)));
    szh->Add(new wxButton(this, wxID_ANY, "Delete"), wxSizerFlags(0).Border(wxRIGHT, FromDIP(5)));
    szr->Add(szh);
  }
...
void wxStatusPanel::OnSize(wxSizeEvent& event)
{
  ...
  int r = szr->GetSize().GetWidth();
  int border = FromDIP(20) * 2 + 3;
  int icon = 112;
  int spacing = FromDIP(10);
